...
class Embedding(object):
    def __init__(self, prefix, data_shape, batch_size=1):
        ...
        weight = torch.load(prefix, map_location=cfg.device)
        resnet = get_model(network, dropout=0, fp16=False, num_features=cfg.embedding_size).to(cfg.device)
    ...
    def forward_db(self, batch_data):
        imgs = torch.Tensor(batch_data).to(cfg.device)
