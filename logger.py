        ...
        if self.rank == 0 and global_step > 0 and global_step % self.frequent == 0:
            if self.init:
                ...
                if self.writer is not None:
                    ...
                    self.writer.add_scalar('loss_ce', loss_ce, global_step)
                    self.writer.add_scalar('loss_p', loss_p, global_step)
                    self.writer.add_scalar('norm of f', norm_embedding, global_step)
                    self.writer.add_scalar('norm of w', norm_weight, global_step)
                if fp16:
